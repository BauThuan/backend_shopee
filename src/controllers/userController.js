...
let registerExraInfor = async (req, res) => {
  try {
    let { email, firstName, lastName, phoneNumber, address, genderId } =
      req.body;
    if (
      !email ||
      !firstName ||
...
let addOneCart = async (req, res) => {
  try {
    ...
    let response = await userService.addOneCart({
      ...req.body,
      userId: req.userId,
    });
    return res.status(200).json(response);
...
let borrowNowCart = async (req, res) => {
  try {
    ...
    let response = await userService.borrowNowCart({
      ...req.body,
      userId: req.userId,
    });
    return res.status(200).json(response);
...
let editExtraInfor = async (req, res) => {
  try {
    ...
    let response = await userService.editExtraInfor({
      ...req.body,
      userId: req.userId,
    });
    return res.status(200).json(response);
...
let getAllCartByStatusId = async (req, res) => {
  try {
    ...
    let response = await userService.getAllCartByStatusId({
      ...req.query,
      userId: req.userId,
    });
    return res.status(200).json(response);
