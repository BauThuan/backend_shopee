...
let updateUserById = async (req, res) => {
  try {
    let { firstName, lastName, address, phoneNumber, genderId, roleId } =
      req.body;
    let { id } = req.query;
    ...
    let response = await systemService.updateUserById({
      ...req.body,
      ...req.query,
    });
    return res.status(200).json(response);
...
let updateBookById = async (req, res) => {
  try {
    ...
    let response = await systemService.updateBookById({
      ...req.body,
      ...req.query,
    });
    return res.status(200).json(response);
...
let updateAuthorById = async (req, res) => {
  try {
    ...
    let response = await systemService.updateAuthorById({
      ...req.body,
      ...req.query,
    });
    return res.status(200).json(response);
...
let updateShelfById = async (req, res) => {
  try {
    ...
    let response = await systemService.updateShelfById({
      ...req.body,
      ...req.query,
    });
    return res.status(200).json(response);
...
let addNewClother = async (req, res) => {
  try {
    let { name, status, purchases, price, percent, image } = req.body;
    if (!name || !status || !purchases || !price || !percent || !image) {
      return res.status(200).json({
        errCode: 1,
        messageEN: "Missing information in request ",
        messageVI: "Thiếu thông tin chuyền lên ",
    ...
    let response = await systemService.addNewClother(req.body);
    return res.status(200).json(response);
  } catch (error) {
    console.log(error);
    return res.status(200).json({
